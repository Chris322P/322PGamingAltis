...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\adac_offroad.jpg","cop"],
			["#(ai,64,64,1)Fresnel(0.3,3)","fed"],
			["textures\cop_offroad.jpg","cop"],
	...
	case "O_Plane_CAS_02_F":
	{
		...
		[
			...
			["#(argb,8,8,3)color(30,90,170,1)","cop","#(argb,8,8,3)color(0,0,0,1)"],
			["\A3\air_f_epc\Plane_CAS_02\data\fighter02_ext01_co.paa","cop","\A3\air_f_epc\Plane_CAS_02\data\fighter02_ext02_co.paa"]
		];
	};	
	case "B_UAV_02_F":
	{
